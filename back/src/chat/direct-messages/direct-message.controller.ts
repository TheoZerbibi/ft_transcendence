...
export class DirectMessageController {
	...
	async getAllDirectMessages(@GetUser() user: User, @Param('username') username: string): Promise<DirectMessageDto[]> {
	...
	async createDirectMessage(@GetUser() user: User, @Param('username') username: string, @Body() dto: CreateDirectMessageDto): Promise<DirectMessageDto> {
